...
final class GWF_Time
{
	 ...
	 * @return unknown_type
	 */
	public static function displayTimestamp($timestamp=null, string $format='short', $default_return='---')
	{
		return self::displayTimestampISO(GWF_Trans::$ISO, $timestamp, $format, $default_return);
	}

	public static function displayTimestampISO($iso, $timestamp=null, string $format='short', $default_return='---')
	{
		return $timestamp === null ? $default_return : date(t('df_'.$format), $timestamp);
	}

	public static function displayDate($date=null, string $format='short', $default_return='---')
	{
		
		return self::displayTimestamp(self::getTimestamp($date), $format, $default_return);
	}

	public static function displayDateISO(string $iso, $date=null, string $format='short', $default_return='---')
	{
	...
	{
		return self::humanDurationISO(GWF_Trans::$ISO, $duration, $nUnits);
	}
